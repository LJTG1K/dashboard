...
export const projects: Project[] = [
  {
    ...
    metrics: [
      { label: 'Status', value: 'Phase 1: WEEK 1 COMPLETE ✅' },
      { label: 'Core Pillars', value: '4 (Memory, Voice, Agency, Persona)' },
      { label: 'Timeline', value: '20+ weeks (phased)' },
      { label: 'Current Focus', value: 'Query system + Phase 2 prep' },
    ],
    nextSteps: [
      '✅ Week 1 (May 12-18): Memory audit, relational model, structured logging [COMPLETE]',
    ...
    resources: [
      { label: '📋 Week 1 Completion Summary', url: '/docs/JARVIS/WEEK1_COMPLETION.md' },
      { label: '🔍 Memory Audit', url: '/docs/JARVIS/JARVIS_MEMORY_AUDIT.md' },
      { label: '🗂️ Relational Model (Design)', url: '/docs/JARVIS/JARVIS_RELATIONAL_MODEL.md' },
      { label: '📊 Structured Log (JSON)', url: '/docs/JARVIS/JARVIS_LOG.json' },
      { label: '🔗 Project Dependency Graph', url: '/docs/JARVIS/JARVIS_PROJECT_GRAPH.md' },
      { label: '⚙️ Query System (Python)', url: '/docs/JARVIS/jarvis_query.py' },
  ...
  },
  {
    ...
    resources: [
      ...
      { label: '�� Logo Brief', url: '/docs/RAPID/LOGO_BRIEF.md' },
